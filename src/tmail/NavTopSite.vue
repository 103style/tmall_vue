      ...
      websiteNavs: [
        {
          ...
          items: [
            { title: "天猫超市" },
            { title: "喵鲜生" },
            { title: "科技新品", isNew: true },
            { title: "女装新品", isHot: true },
            { title: "酷玩街" },
            { title: "内衣新品", isHot: true },
            { title: "试美妆" },
            { title: "运动新品" },
            { title: "时尚先生", isHot: true },
            { title: "精明妈咪" },
            { title: "吃乐会", isNew: true },
            { title: "企业采购" },
            { title: "会员积分" },
            { title: "天猫国际" },
            { title: "品质频道" },
...
#navTopSite {
  ...
  .navTopSiteBox {
    ...
    .right {
      ...
      .sitemap:after, .hoverwhite:after {
        content: ' ';
        position: absolute;
        top: 16px;
        right: 7px;
      ...
      .sitemap:hover:after, .hoverwhite:hover:after {
        top: 12px;
